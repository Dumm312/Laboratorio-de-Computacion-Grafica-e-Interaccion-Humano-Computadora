...
int main()
{
	...
	CrearCono(40, 1.0f);//índice 3 en MeshList
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		//VENTANA VERDE ENFRENTE IZQUIERDA
		model = glm::mat4(1.0f);
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(-0.3f, 0.3f, -4.44f));
		...
		//VENTANA VERDE ENFRENTE DERECHA
		model = glm::mat4(1.0f);
		//color = glm::vec3(0.0f, 1.0f, 0.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.3f, 0.3f, -4.44f));
		...
		//PUERTA VERDE ENFRENTE 
		model = glm::mat4(1.0f);
		//color = glm::vec3(0.0f, 1.0f, 0.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.0f, -0.546f, -4.44f));
		model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		...
		//VENTANA VERDE DERECHA LADO IZQUIERDO
		model = glm::mat4(1.0f);
		//color = glm::vec3(0.0f, 1.0f, 0.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(-0.56f, 0.3f, -4.7f));
		model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		...
		//VENTANA VERDE IZQUIERDA LADO IZQUIERDO
		model = glm::mat4(1.0f);
		//color = glm::vec3(0.0f, 1.0f, 0.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(-0.56f, 0.3f, -5.3f));
		model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		...
		//VENTANA VERDE IZQUIERDA LADO DERECHO
		model = glm::mat4(1.0f);
		//color = glm::vec3(0.0f, 1.0f, 0.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.56f, 0.3f, -4.7f));
		...
		//VENTANA VERDE DERECHA LADO DERECHO
		model = glm::mat4(1.0f);
		//color = glm::vec3(0.0f, 1.0f, 0.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.56f, 0.3f, -5.3f));
		...
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.0f, 1.001f, -5.0f));
		...
		//VENTANA CILINDRICA AZUL ATRÁS
		model = glm::mat4(1.0f);
		//color = glm::vec3(0.0f, 0.0f, 1.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -5.51f));
		...
		//TRONCO CAFE CILINDRICO IZQUIERDA
		model = glm::mat4(1.0f);
		color = glm::vec3(0.478f, 0.255f, 0.067f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(-1.5f, -0.546f, -5.375f));
		...
		//TRONCO CAFE CILINDRICO DERECHA
		model = glm::mat4(1.0f);
		//color = glm::vec3(0.478f, 0.255f, 0.067f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(1.5f, -0.546f, -5.375f));
		...
		//ÁRBOL VERDE OSCURO PIRAMIDE CUADRANGULAR IZQUIERDA
		model = glm::mat4(1.0f);
		color = glm::vec3(0.0f, 0.5f, 0.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(-1.5f, 0.05f, -5.375f));
		...
		//ÁRBOL VERDE OSCURO PIRAMIDE CUADRANGULAR DERECHA
		model = glm::mat4(1.0f);
		//color = glm::vec3(0.0f, 0.5f, 0.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(1.5f, 0.05f, -5.375f));
		...
		//PISO DEL ÁREA CUBO CYAN
		model = glm::mat4(1.0f);
		color = glm::vec3(0.0f, 1.0f, 1.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.0f, -0.8f, -5.375f));
