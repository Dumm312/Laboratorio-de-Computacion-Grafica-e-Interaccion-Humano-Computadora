...
public:
	...
	GLboolean getarticulacion2()  { return articulacion2; }
...
private: 
	...
	GLint width, height;
	GLfloat rotax,rotay,rotaz, articulacion1, articulacion3, articulacion4, articulacion5, articulacion6,
