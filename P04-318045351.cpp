...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Articulación Superior Pata Frontal Derecha
		model = modelaux4;
		...
		//Articulación Superior Pata Frontal Izquierda
		model = modelaux5;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -2.5f));
		...
		//Articulación Superior Pata Trasera Derecha
		model = modelaux1;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 2.5f));
		...
		//Articulación Superior Pata Trasera Izquierda
		model = modelaux6;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -2.5f));
